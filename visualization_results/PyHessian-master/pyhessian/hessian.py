...
class hessian():
    ...
    def __init__(self, model, criterion, data=None, dataloader=None, cuda=True, whole_model=True, layer=0):
        """
        ...
        params, gradsH = get_params_grad(self.model, self.whole_model, self.layer)
        self.params = params
